...
- We ran a controlled A/B study across 14 decision scenarios with the same agents, the same personas, and the same goals, first without Mycelium and then with it, measuring consensus rate, outcome quality, and token cost against a withheld ground-truth benchmark.
