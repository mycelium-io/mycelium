...
if TYPE_CHECKING:
    from ..models.agent_read_memory_config_type_0 import AgentReadMemoryConfigType0
...
class AgentRead:
    ...
    Attributes:
        ...
        memory_config (AgentReadMemoryConfigType0 | None | Unset):
    """
    ...
    memory_config: AgentReadMemoryConfigType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.memory_config, Unset):
            memory_config = UNSET
        elif isinstance(self.memory_config, AgentReadMemoryConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_memory_config(data: object) -> AgentReadMemoryConfigType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                memory_config_type_0 = AgentReadMemoryConfigType0.from_dict(data)

                return memory_config_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AgentReadMemoryConfigType0 | None | Unset, data)
