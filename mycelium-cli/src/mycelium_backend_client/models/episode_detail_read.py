...
if TYPE_CHECKING:
    from ..models.episode_detail_read_assignments_type_0 import EpisodeDetailReadAssignmentsType0
    from ..models.episode_metrics_read import EpisodeMetricsRead
    from ..models.l9_envelope_read import L9EnvelopeRead


T = TypeVar("T", bound="EpisodeDetailRead")


@_attrs_define
class EpisodeDetailRead:
    """
    Attributes:
        short_id (str):
        episode (str):
    ...
    assignments: EpisodeDetailReadAssignmentsType0 | None | Unset = UNSET
    plan_file: None | str | Unset = UNSET
    message_count: int | Unset = 0
    updated_at: str | Unset = ""
    updated_by: str | Unset = ""
    messages: list[L9EnvelopeRead] | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.episode_detail_read_assignments_type_0 import (
        ...
        if isinstance(self.assignments, Unset):
            assignments = UNSET
        elif isinstance(self.assignments, EpisodeDetailReadAssignmentsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_assignments(data: object) -> EpisodeDetailReadAssignmentsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                assignments_type_0 = EpisodeDetailReadAssignmentsType0.from_dict(data)

                return assignments_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EpisodeDetailReadAssignmentsType0 | None | Unset, data)
        ...
        if _messages is not UNSET:
            ...
            for messages_item_data in _messages:
                messages_item = L9EnvelopeRead.from_dict(messages_item_data)

                messages.append(messages_item)

        episode_detail_read = cls(
            short_id=short_id,
            episode=episode,
            topic=topic,
            outcome=outcome,
        ...
        episode_detail_read.additional_properties = d
        return episode_detail_read
