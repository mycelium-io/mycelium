...
const plugin = {
    ...
    description: "Bridges OpenClaw agents to the Mycelium coordination backend. Covers session lifecycle, pre-turn context injection, addressed messaging via the mycelium-room channel, and knowledge graph ingest.",
    register,
};
