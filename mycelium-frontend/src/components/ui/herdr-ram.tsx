...
/** The herdr ram mark (https://herdr.dev/assets/ram.svg), inlined so it inherits
 *  `currentColor` and sizes with the surrounding text. Used to denote a
 *  herdr-hosted member in the roster — the glyph that replaces the word "herdr". */
export function HerdrRam({
  className,
  style,
}: {
  className?: string;
  ...
  return (
    <svg
      ...
      fill="currentColor"
    >
      <g transform="translate(0 512) scale(.1 -.1)" stroke="none">
