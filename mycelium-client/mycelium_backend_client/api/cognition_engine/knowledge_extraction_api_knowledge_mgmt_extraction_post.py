...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/knowledge-mgmt/extraction",
    }
...
) -> ExtractionResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ExtractionResponse | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ExtractionResponse | HTTPValidationError
    """
